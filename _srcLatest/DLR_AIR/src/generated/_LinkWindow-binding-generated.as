...
class BindableProperty
{
	...
	/**
	 * generated bindable wrapper for property lnkBtnLink (public)
	 * - generated setter
	 * - generated getter
	 * - original public var 'lnkBtnLink' moved to '_1627334387lnkBtnLink'
	 */

    [Bindable(event="propertyChange")]
    public function get lnkBtnLink():mx.controls.LinkButton
    {
        return this._1627334387lnkBtnLink;
    }

    public function set lnkBtnLink(value:mx.controls.LinkButton):void
    {
    	var oldValue:Object = this._1627334387lnkBtnLink;
        if (oldValue !== value)
        {
            this._1627334387lnkBtnLink = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "lnkBtnLink", oldValue, value));
        }
    }
