...
[Mixin]
public class _DailyLanguageReview7_FlexInit
{
   public function _DailyLanguageReview7_FlexInit()
   {
       super();
   }
   public static function init(fbs:IFlexModuleFactory):void
   {
      ...
      if (flash.net.getClassByAlias("flex.messaging.io.ObjectProxy") == null){
          ...
          flash.net.registerClassAlias("flex.messaging.io.ObjectProxy", mx.utils.ObjectProxy); }
      var styleNames:Array = ["fontWeight", "modalTransparencyBlur", "backgroundDisabledColor", "verticalGridLineColor", "barColor", "textAlign", "disabledIconColor", "fontStyle", "titleBarBackgroundSkin", "statusBarBackgroundColor", "modalTransparencyDuration", "titleTextStyleName", "strokeWidth", "horizontalGridLineColor", "fontGridFitType", "disabledColor", "modalTransparencyColor", "titleAlignment", "alternatingItemColors", "dropShadowColor", "titleBarColors", "fontThickness", "fontSharpness", "textDecoration", "statusBarBackgroundSkin", "statusTextStyleName", "strokeColor", "textRollOverColor", "rollOverColor", "textIndent", "fontSize", "kerning", "footerColors", "dropdownBorderColor", "buttonPadding", "textSelectedColor", "buttonAlignment", "modalTransparency", "selectionColor", "fontAntiAliasType", "selectionDisabledColor", "leading", "shadowColor", "iconColor", "themeColor", "letterSpacing", "fontFamily", "color", "errorColor", "headerColors"];
